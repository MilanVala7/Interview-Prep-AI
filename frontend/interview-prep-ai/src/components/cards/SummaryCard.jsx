...
const SummaryCard = ({
    ...
    return <div
        className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer group hover:shadow-xl"
        onClick={onSelect}
    >
        <div
        ...
        >
            ...
            <button
                className="hidden group-hover:flex items-center gap-2 text-xs font-medium bg-rose-50 px-3 py-1 rounded text-nowrap border border-rose-100 hover:border-rose-200 cursor-pointer absolute top-0 right-0 text-rose-500 hover:text-red-500"
                onClick={(e) => {
                    e.stopPropagation();
                    onDelete();
                }}
