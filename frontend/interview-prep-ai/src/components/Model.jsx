    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center h-full w-full bg-black/40">
            <div className="relative flex flex-col bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <button
                    type="button"
                    className="text-gray-400 bg-transparent hover:bg-orange-100 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-3.5 right-3.5 flex justify-center items-center"
                    onClick={onClose}
                >
                    <svg
                        className="w-3 h-3"
