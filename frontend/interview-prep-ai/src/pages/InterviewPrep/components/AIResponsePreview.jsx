      ...
      <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
        <ReactMarkdown
          ...
          components={{
            ...
            td({ children }) {
              return <td className="px-3 py-2 text-sm whitespace-nowrap">{children}</td>;
            },
            hr() {
    ...
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        >
          ...
          {copied && (
            <span className="absolute right-0 transition opacity-80 group-hover:opacity-100 -top-8 bg-black text-white text-xs px-2 py-1 rounded-md">
              Copied!
            </span>
          )}
        </button>
